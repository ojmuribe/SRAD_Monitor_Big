...
#define LV_USE_LOG 0 // *** ... *** Lo pongo a cero para optimizar
#if LV_USE_LOG
...
#define LV_FONT_MONTSERRAT_14 1  /*default font - mantener*/
...
#define LV_USE_ILI9341		0 // *** ... *** Ponerlo a cero para evitar duplicados de drivers según Chatgpt
